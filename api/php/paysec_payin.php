...
$genesis = new Genesis('Financial\OnlineBankingPayments\Paysec\Payin');

/** @var \Genesis\API\Request\Financial\OnlineBankingPayments\PaySec\Payin $paysecPayinRequest */
$paysecPayinRequest = $genesis->request();
