...
$genesis = new Genesis('Financial\Alternatives\Paysafecard');

/** @var \Genesis\API\Request\Financial\Alternatives\Paysafecard $paySafeCardRequest */
$paySafeCardRequest = $genesis->request();
