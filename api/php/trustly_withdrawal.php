...
/** @var \Genesis\API\Request\Financial\Alternatives\Trustly\Withdrawal $trustlyWithdrawalRequest */
$trustlyWithdrawalRequest = $genesis->request();

$trustlyWithdrawalRequest
