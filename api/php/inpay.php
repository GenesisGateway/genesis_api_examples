...
$genesis = new Genesis('Financial\Alternatives\INPay');

/** @var \Genesis\API\Request\Financial\Alternatives\INPay $inpayRequest */
$inpayRequest = $genesis->request();
...
$inpayRequest
    ->setCustomerBankId($_POST['customer_bank_id'])
    ->setOrderDescription($_POST['order_description']);

$inpayRequest
    ->setPayoutOrderId($_POST['payout_order_id'])
    ->setPayoutBankCountry($_POST['payout_bank_country'])
    ->setPayoutBankName($_POST['payout_bank_name'])
    ->setPayoutSwift($_POST['payout_swift'])
    ->setPayoutAccNumber($_POST['payout_acc_number'])
    ->setPayoutBankAddress($_POST['payout_bank_address'])
    ->setPayoutOwnerName($_POST['payout_owner_name'])
    ->setPayoutOwnerAddress($_POST['payout_owner_address']);
