...
/** @var \Genesis\API\Request\Financial\OnlineBankingPayments\InstaDebit\Payout $instaDebitPayoutRequest */
$instaDebitPayoutRequest = $genesis->request();

$instaDebitPayoutRequest
